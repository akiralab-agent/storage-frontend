...
const NAV_ITEMS: NavItem[] = [
  ...
  { to: "/units", label: "Unidades", icon: "box", roles: ["admin", "admin_corporativo", "gerente", "financeiro"] },
  { to: "/facilities", label: "Filiais", icon: "building", roles: ["admin", "admin_corporativo", "gerente"] },
  { to: "/organizations", label: "Organizações", icon: "briefcase", roles: ["admin", "admin_corporativo"] },
